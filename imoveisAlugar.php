...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./css/styleImoveisAluga.css" />
  </head>
  <body>
    <header>
      <nav>
    ...
    <div class="page-guide">
      <ul>
        <li><a href="index.php">Village Imobiliária</a></li>
        <li><a href="imoveis.php">Resultados da sua busca</a></li>
      </ul>
    </div>
    ...
    <main>
      <div class="results-block">
        <div class="text_title">
          <h1> 23 Imoveis para alugar na sua busca</h1>
        </div>
