<?php 
    ...
    $sqlVenda = 'SELECT * from imoveis where statusImovel = "Venda" limit 4';

    $sqlAluga = 'SELECT * from imoveis where statusImovel = "Alugar" limit 4';
?>
...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <section class="cards">
      <?php foreach ($conexao->query ($sqlVenda) as $row) { ?>
      ...
      <section class="cards">
      <?php foreach ($conexao->query ($sqlAluga) as $row) { ?>
