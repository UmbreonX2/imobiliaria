...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./css/styleCadastrarImovel.css" />
  </head>
  <body>
    <header>
      ...
      <main>
        <section id="form">
            <form action="InserirImovel.php" method="post" >
              ...
              <div class="form-group">
                <select class="input-control" name="dormitorios">
              ...
              <div class="form-group">
                <textarea class="input-control" placeholder="Observações" name="observacao"></textarea>
              </div>
