<?php
    ...
    $sqlImovel = "SELECT * FROM imoveis where idImoveis = " .  $id; 

     foreach ($conexao->query($sqlImovel) as $row) {
      $cidade = $row['cidade'];
      $banheiro = $row['banheiros'];
      $dormitorios = $row['dormitorios'];
      $suites = $row['suites'];
      $endereco = $row['endereco'];
      $codigo = $row['idImoveis'];
      $area = $row['areaTerreno'];
      $vagas = $row['vagasCobertas'];
      $valor = $row['valorImovel'];
      $obs = $row['observacao'];
    }  
?>
      ...
      <section>
        ...
        <div class="template details-imoveis">
          <div class="header-details">
            <h1>Casa à venda em <?= $cidade ?>, <?= $dormitorios ?> dormitórios, <?= $suites ?> suíte, <?= $banheiro ?> Banheiros</h1>
              <div class="details">
                <ul>
                  <li><?= $endereco ?>, <?= $cidade ?></li>
                  <li>Código do imóvel: <?= $codigo ?></li>
                </ul>
              </div>
              <div class="details2">
        ...
        <div class="content-details">
          <div class="about">
            ...
            <div class="description">
              <span>Sobre</span>
              <div class="line1"></div>
              <h2><?= $obs ?>. Quer saber mais? Consulte um de nossos especialistas</h2>
            </div>
